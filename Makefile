...
profile-server:
	...
	python utils/gprof2dot.py  -f pstats profiling/gottwall_server.pyprof | dot -Tpng -o profiling/server_profile.png
...
profile-aggregator:
	...
	python utils/gprof2dot.py  -f pstats profiling/gottwall_aggregator.pyprof | dot -Tpng -o profiling/aggregator_profile.png